...
{
	public static final TetrisBlock LONG = new Long();

	public static final TetrisBlock LEFT_L = new LeftL();

	public static final TetrisBlock TEE = new Tee();

	public static final TetrisBlock RIGHT_L = new RightL();

	public static final TetrisBlock SQUARE = new Square();
	...
	protected TetrisBlock(boolean[][] blocks, Color color)
	{
		this.blocks = blocks;
		this.color = color;
	}
