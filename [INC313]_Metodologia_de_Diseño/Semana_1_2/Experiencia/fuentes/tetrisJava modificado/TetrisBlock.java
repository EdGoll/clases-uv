...
public class TetrisBlock
{
	...
	public static final TetrisBlock ESE = new TetrisBlock(new boolean[][]{
			{false, true, true}, {true, true, false}}, Color.ORANGE);

	public static final TetrisBlock ZETA = new TetrisBlock(new boolean[][]{
			{true, true, false}, {false, true, true}}, Color.YELLOW);

	public static final TetrisBlock MEGA = new TetrisBlock(new boolean[][]{
			{true, true, true, true}, {true, true, true, true}}, Color.PINK);
