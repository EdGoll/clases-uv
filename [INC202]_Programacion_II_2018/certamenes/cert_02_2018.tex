...
\item \textbf{\emph{40pts.}} Implemente un programa en lenguaje Java
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{enumerate}
        \item \emph{35pts.} Implementar una clase GestionPersona que provea los siguiente:
        \begin{itemize}
          \item \emph{5pts.} Un Arreglo Din\'amico de tipo ArrayList como atributo.
          \item \emph{10pts.} Implementar el m\'etodo crear que permita ingresar los datos requeridos para cada persona cumpliendo con el esquema de herencia agregando cada persona al arreglo.
          \item \emph{10pts.} Implementar el m\'etodo guardar que recorra el Arreglo Din\'amico y  que tenga la responsabilidad de guardar el registro dentro del archivo identificadose claramente el tipo de persona guardada.
          \item \emph{10pts.} Implementar el m\'etodo listar que lea el archivo y liste todos sus registros.
        \end{itemize}
        \item \emph{30pts.} Implementar la clase PersonaMain que permita ejecutar el programa y los m\'etodos asociados. El n\'umero de personas a crear depende del usuario..

    \end{enumerate}
    \begin{itemize}
        \item[$\rightarrow$] \textbf{Recomendaci\'on}: Utilice el nombre FuenteDatos para el archivo generado.
