...
\begin{enumerate}
    ...
    \item \emph{60pts.} Desarrolle una aplicaci\'on en JAVA, con interfaz de usuario que permita mostrar en alg\'un componente de salida, la informaci\'on bancaria de abono y giro de un cliente, simulado por procesos concurrentes. Para ellos se solicita lo siguiente:
