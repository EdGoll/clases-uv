...
\begin{frame}{Complejidad temporal vs. complejidad espacial}
  \begin{itemize}
    ...
    \item<2-> Dado un algoritmo $A$ que resuelve un problema en tiempo $T$ ocupando un espacio de memoria $S$.
      \begin{itemize}
        \item<3-> Si $T$ es polinomial, entonces $S$... \uncover<4->{es polinomial.}
        \item<5-> Si $T$ es exponencial, entonces $S$... \uncover<6->{puede ser exponencial o polinomial.}
...
%------------------------------
\subsection{Análisis y comparación de algoritmos}

\begin{frame}{Actividad}
  Comparar tiempo de ejecución de algoritmos de ordenamiento \blue{Bubble sort} y \blue{Quicksort}.\\
  \redb{\scriptsize\url{https://github.com/vbohush/SortingAlgorithmAnimations/tree/master/src/net/bohush/sorting}}
  \begin{enumerate}
      \item Buscar complejidad temporal teórica en notación Big O.
      \item Ejecutar y comparar para listas ordenadas, desordenadas y ordenadas inversas.
      \item Modificar algoritmos para contar número de pasos para cada ejecución.
  \end{enumerate}
\end{frame}
